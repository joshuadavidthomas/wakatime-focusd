...
- Shell installer script for one-line installation (`curl | sh`), powered by [cargo-dist](https://opensource.axo.dev/cargo-dist/)
- [cargo-binstall](https://github.com/cargo-bins/cargo-binstall) support for pre-built binary installation
...
[unreleased]: https://github.com/joshuadavidthomas/wakatime-focusd/compare/v0.4.1...HEAD
...
[0.4.1]: https://github.com/joshuadavidthomas/wakatime-focusd/releases/tag/v0.4.1
